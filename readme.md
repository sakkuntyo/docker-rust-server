...
[Rust Monitor 0.2.1 の ZIP をダウンロード](https://github.com/sakkuntyo/docker-rust-server/releases/download/1.1.7/RustMonitor-0.2.1-windows.zip)。Windows 10/11 と .NET 10 Desktop Runtime が必要です。
